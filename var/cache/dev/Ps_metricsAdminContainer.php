...
class Ps_metricsAdminContainer extends Container
{
     ...
     *
     * @return \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Facade\PsAccounts
     */
    protected function getPsAccounts_FacadeService()
    {
        return $this->services['ps_accounts.facade'] = new \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Facade\PsAccounts(($this->services['ps_accounts.installer'] ?? ($this->services['ps_accounts.installer'] = new \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Installer('5.0'))));
    }

    /**
     * Gets the public 'ps_accounts.installer' shared service.
     *
     * @return \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Installer
     */
    protected function getPsAccounts_InstallerService()
    {
        return $this->services['ps_accounts.installer'] = new \ps_metrics_module_v4_1_1\PrestaShop\PsAccountsInstaller\Installer\Installer('5.0');
    }
