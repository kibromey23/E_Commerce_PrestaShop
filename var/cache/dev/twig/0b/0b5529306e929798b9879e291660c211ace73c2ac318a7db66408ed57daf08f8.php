...
class __TwigTemplate_0cf7467936cd31506296eed02ba3f68f2f28fb5c6a4363394c55a590d3d28252 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 45
        if (((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 45, $this->source); })()), "actions", [], "any", false, false, false, 45), "bulk", [], "any", false, false, false, 45)), 0)) || (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 45, $this->source); })()), "filter_form", [], "any", false, false, false, 45)), 1)))) {
            // line 46
            echo "      ";
...
", "@PrestaShop/Admin/Common/Grid/Blocks/table.html.twig", "C:\\xampp\\htdocs\\E_Commerce_PrestaShop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Blocks\\table.html.twig");
    }
}
