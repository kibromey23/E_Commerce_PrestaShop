...
class __TwigTemplate_149f50b1e743822d8b69facdd571ad821a1ecaec230f90fb79a3590a03bf2aa5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_sortable_column_header($__title__ = null, $__sortColumnName__ = null, $__orderBy__ = null, $__sortOrder__ = null, $__prefix__ = null, ...$__varargs__)
    {
      ...
      ";
            // line 79
            if ((0 === twig_compare((isset($context["orderBy"]) || array_key_exists("orderBy", $context) ? $context["orderBy"] : (function () { throw new RuntimeError('Variable "orderBy" does not exist.', 79, $this->source); })()), (isset($context["sortColumnName"]) || array_key_exists("sortColumnName", $context) ? $context["sortColumnName"] : (function () { throw new RuntimeError('Variable "sortColumnName" does not exist.', 79, $this->source); })())))) {
                // line 80
                echo "        data-sort-is-current=\"true\"
        data-sort-direction=\"";
                // line 81
                echo (((0 === twig_compare((isset($context["sortOrder"]) || array_key_exists("sortOrder", $context) ? $context["sortOrder"] : (function () { throw new RuntimeError('Variable "sortOrder" does not exist.', 81, $this->source); })()), "desc"))) ? ("desc") : ("asc"));
                echo "\"
      ";
            }
            // line 83
...
";
  ...
  ";
            // line 147
            if ((1 === twig_compare(twig_length_filter($this->env, (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 147, $this->source); })())), 0))) {
                // line 148
                echo "    ";
                // line 149
                echo "    ";
    ...
    ";
                // line 151
                if ((1 === twig_compare(twig_length_filter($this->env, (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 151, $this->source); })())), 1))) {
                    // line 152
                    echo "      ";
...
{% endmacro %}
", "@PrestaShop/Admin/macros.html.twig", "C:\\xampp\\htdocs\\E_Commerce_PrestaShop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\macros.html.twig");
    }
}
