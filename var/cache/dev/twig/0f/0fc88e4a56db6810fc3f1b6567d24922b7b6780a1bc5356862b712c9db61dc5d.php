...
class __TwigTemplate_ed152a5ed891a649fcf697f3cf2c97014bfa4f255a7aada000cf04ca1c0f0ebb extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 26
        if (((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 26, $this->source); })()), "actions", [], "any", false, false, false, 26), "bulk", [], "any", false, false, false, 26)), 0)) && (1 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 26, $this->source); })()), "data", [], "any", false, false, false, 26), "records_total", [], "any", false, false, false, 26), 0)))) {
            // line 27
...
{% endif %}
", "@PrestaShop/Admin/Common/Grid/Blocks/bulk_actions.html.twig", "C:\\xampp\\htdocs\\E_Commerce_PrestaShop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Blocks\\bulk_actions.html.twig");
    }
}
