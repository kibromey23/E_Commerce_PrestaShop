...
class __TwigTemplate_0fa1243b217696a44eb41c5134aefca8938ece0e06863993b02e92eccc6a6eed extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      <div class=\"sf-toolbar-info-piece\">
        ...
        if ((1 === twig_compare((isset($context["commandsCount"]) || array_key_exists("commandsCount", $context) ? $context["commandsCount"] : (function () { throw new RuntimeError('Variable "commandsCount" does not exist.', 42, $this->source); })()), 0))) {
            echo "green";
        } else {
            echo "red";
        }
      ...
      <div class=\"sf-toolbar-info-piece\">
        ...
        // line 49
        echo "        <span class=\"sf-toolbar-status sf-toolbar-status-";
        if ((1 === twig_compare((isset($context["queriesCount"]) || array_key_exists("queriesCount", $context) ? $context["queriesCount"] : (function () { throw new RuntimeError('Variable "queriesCount" does not exist.', 49, $this->source); })()), 0))) {
            echo "green";
        } else {
            echo "red";
        }
...
{% endblock %}
", "@PrestaShop/Admin/WebProfiler/commands_and_queries.html.twig", "C:\\xampp\\htdocs\\E_Commerce_PrestaShop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\WebProfiler\\commands_and_queries.html.twig");
    }
}
