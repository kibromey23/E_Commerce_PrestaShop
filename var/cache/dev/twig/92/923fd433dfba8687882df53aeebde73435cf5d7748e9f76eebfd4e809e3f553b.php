...
class __TwigTemplate_2dcc1eb3db04205b57e7c1564f36b6c6d95bd4719d4d2b33981bedecb5a184c9 extends Template
{
    private $source;
    private $macros = [];
...
<tr class=\"column-filters";
  ...
  ";
    ...
    >
      ";
            // line 32
            if ((twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 32) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 32, $this->source); })()), "actions", [], "any", false, false, false, 32), "bulk", [], "any", false, false, false, 32)), 0)))) {
                // line 33
                echo "        ";
      ...
      ";
            // line 36
            if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 36, $this->source); })()), "filter_form", [], "any", false, false, false, 36)), 1))) {
                // line 37
                echo "        ";
...
", "@PrestaShop/Admin/Common/Grid/Blocks/Table/filters_row.html.twig", "C:\\xampp\\htdocs\\E_Commerce_PrestaShop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Blocks\\Table\\filters_row.html.twig");
    }
}
